      ...
      <div className='text-container'>
        <div className='text'>
          ...
          <p className='text-lectie'>
            ...
            curent, dar Stephane Mallarmé este cel care îl întruchipează cel mai bine în poezie.
          </p>
          <p className='text-lectie'>
          ...
          angoasele, identitare ale Eului, imaginea femeii, arta pentru artă, decadenta.
          </p>
          <p className='text-lectie'>
